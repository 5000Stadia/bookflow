...
def test_an_innocuously_named_nested_field_fails_the_closure():
    ...
    with pytest.raises(BookflowError) as caught:
        manifest.conform(roots=(probe_show, probe_page, m.DepositPage, m.DepositHistoryPage))
...
def test_an_unnamed_public_field_fails_the_closure():
    ...
    with pytest.raises(BookflowError) as caught:
        manifest.conform(public_roots=(w.DepositDetail, w.DepositItemsPage, w.DepositQueryPage,
                                       w.DepositHistoryPage, probe))
