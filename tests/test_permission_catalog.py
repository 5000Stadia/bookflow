...
RESOURCE_PAIRS = {
    ...
    'payment_selection.query_page': {('customer-work', 'member')},
}
...
def test_frozen_manifest_digest_and_pure_import_boundary():
    assert c.FROZEN_CATALOG.version == 'fe3b8c73a9d9dce7db159e87c62b5cd2bf2d4252'
    ...
    assert hashlib.sha256(raw).hexdigest() == '8015a4ca82972398c15a91f1bd29c52b95ddc4d4195fbf0abc51c743269ad9f6'
