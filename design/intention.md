...
| 23 | Hosted credential revalidation. Revalidate admitted HTTP/workbench credentials inside the actual command session before execution, including queued writes. | A credential revoked, expired or invalidated after admission cannot plan or execute queued work; ordinary authorized commands and self-revocation remain correct, with deterministic real-host regressions and independent review. Plan: design/specs/23-hosted-credential-revalidation.md. |
