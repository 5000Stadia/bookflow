...
| 18 | Partial and progress work billing. Extend linked estimates/work orders with exact quantity, net-amount and original-scope percentage allocations, truthful fractional quantities and independent source proofs. See [owning plan](specs/18-progress-billing.md). | Partial invoices and paid receipts share source-root entitlement without overlap; net reconciles on completion and each bill calculates ordinary tax from its allocated net and captured rates. Corrections, late voids, rebills and legacy retries preserve exact accounting and unrelated installments; desktop/phone forms show previous, current and remaining work. |
