...
`co0056` adds `journal_deletions` with the same shape as `co0052` -- immutable tombstone,
...
that forgot to ask. It is last in the chain -- `co0053` credit, `co0054` deposit, `co0055` job time,
`co0056` here -- because journal-entry deletion is the family that closes the set.
