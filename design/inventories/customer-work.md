...
| CW09 | Estimate/progress preferences and numbering; observed family | The [customer-work preferences contract](../customer-work-preferences.md) implements separate estimate/progress controls, preservation when disabled and optional final-estimate inactivation. Duplicate numbers remain rejected. Item-creation markup percent/account, job-status labels and default billable-time/expense preferences retain their master/source settings dependencies. | H6, H13, W2 |
