...
| CW09 | Estimate/progress preferences and numbering; observed family | Inventory separate estimate and progress feature preferences, duplicate-number behavior and automatic closure after conversion. Define visibility/default scope and preservation when disabled; a visibility preference cannot authorize duplicate billing. | H6, H13, W2 |
...
| CW15 | Work-order lines; approved extension | Item, description, quantity, rate and billable flag; carry source facts without retyping and retain line ancestry. Completion must not bill nonbillable lines. Labor/time capture and dispatch automation remain separate dependencies. | L1–L4, W1–W2; blueprint 13.1–13.2 |
...
| CW46 | Stock, assemblies and fulfillment; observed family | Staged inventory/costing, units, availability, commitments, partial shipment/backorders and material-quantity rules. A quote may describe goods only under explicit non-posting rules; conversion must reject unsupported financial/stock effects. | L7, W3, D8 |
