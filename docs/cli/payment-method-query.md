...
# `payment-method query` commands

## `payment-method query options`

Discover a bounded page of named columns, filters, sorts or custom choices for payment methods.
...
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/payment-method.query.options` |
| External binary body | none |

### CLI

`bookflow payment-method query options --kind columns --limit 50 --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/payment-method.query.options`
