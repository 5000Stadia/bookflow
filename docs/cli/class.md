...
`bookflow class activate 01ARZ3NDEKTSV4RRFFQ69G5FAV --expected-version 2 --company "Demo Plumbing Co" --json`

### Input

| JSON field | CLI input | Type | Required | Nullable | Default | Description and constraints |
|---|---|---|---|---|---|---|
| `class` | `CLASS` | string | yes | no | — | class id or canonical name |
...
Route: `POST /companies/{company_id}/commands/class.activate`
...
`bookflow class create --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/class.create`
...
`bookflow class deactivate 01ARZ3NDEKTSV4RRFFQ69G5FAV --expected-version 1 --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/class.deactivate`
...
`bookflow class list --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/class.list`
...
Query a bounded page of classes.
...
`bookflow class query --limit 25 --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/class.query`
...
| `items[].active` | boolean | yes | no | — | — |
| `items[].full_name` | string | no | no | — | Present in ClassSummary. |
| `items[].parent_id` | string \| null | no | yes | — | Present in ClassSummary. |
...
`bookflow class show 01ARZ3NDEKTSV4RRFFQ69G5FAV --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/class.show`
...
`bookflow class update 01ARZ3NDEKTSV4RRFFQ69G5FAV --expected-version 1 --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/class.update`
