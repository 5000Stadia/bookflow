...
Discover a bounded page of named columns, filters, sorts or custom choices for classes.
...
| Capability | class |
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/class.query.options` |
| External binary body | none |

### CLI

`bookflow class query options --kind columns --limit 50 --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/class.query.options`
