...
Route: `POST /companies/{company_id}/commands/custom-field.activate`
...
| `name` | string | yes | no | — | — |
| `kind` | literal["text", "number", "date", "bool", "choice"] | yes | no | — | — |
| `position` | integer | yes | no | — | — |
| `required` | boolean | yes | no | — | — |
| `default` | any \| null | yes | yes | — | — |
| `target_types` | array[string] | yes | no | — | — |
| `scopes` | array[object] | yes | no | — | — |
| `scopes[].id` | string | yes | no | — | — |
| `scopes[].record_type` | string | yes | no | — | — |
| `scopes[].position` | integer | yes | no | — | — |
| `scopes[].active` | boolean | yes | no | — | — |
| `choices` | array[object] | yes | no | — | — |
| `choices[].id` | string | yes | no | — | — |
| `choices[].value` | string | yes | no | — | — |
| `choices[].position` | integer | yes | no | — | — |
| `choices[].active` | boolean | yes | no | — | — |
...
| `scopes` | `--scopes` | array[literal["customer", "vendor", "employee", "other_name", "item", "journal_entry", "invoice", "sales_receipt", "credit_memo", "payment", "deposit", "bill", "bill_payment", "check", "credit_card_charge", "transfer", "inventory_adjustment", "vendor_credit", "proposal", "work_order", "estimate", "time_activity", "sales_order", "purchase_order", "item_receipt", "statement", "statement_charge"]] | yes | no | — | — |
...
Route: `POST /companies/{company_id}/commands/custom-field.create`
...
Route: `POST /companies/{company_id}/commands/custom-field.deactivate`
...
Route: `POST /companies/{company_id}/commands/custom-field.list`
...
| `items[].kind` | literal["text", "number", "date", "bool", "choice"] | yes | no | — | — |
| `items[].position` | integer | yes | no | — | — |
| `items[].required` | boolean | yes | no | — | — |
| `items[].default` | any \| null | yes | yes | — | — |
| `items[].target_types` | array[string] | yes | no | — | — |
| `items[].scopes` | array[object] | yes | no | — | — |
| `items[].scopes[].id` | string | yes | no | — | — |
| `items[].scopes[].record_type` | string | yes | no | — | — |
| `items[].scopes[].position` | integer | yes | no | — | — |
| `items[].scopes[].active` | boolean | yes | no | — | — |
| `items[].choices` | array[object] | yes | no | — | — |
| `items[].choices[].id` | string | yes | no | — | — |
| `items[].choices[].value` | string | yes | no | — | — |
| `items[].choices[].position` | integer | yes | no | — | — |
| `items[].choices[].active` | boolean | yes | no | — | — |
...
Route: `POST /companies/{company_id}/commands/custom-field.query`
...
| `items[].active` | boolean | yes | no | — | — |
| `items[].name` | string | no | no | — | Present in CustomFieldSummary. |
| `items[].position` | integer | no | no | — | Present in CustomFieldSummary. |
| `items[].target_types` | array[string] | no | no | — | Present in CustomFieldSummary. |
| `items[].kind` | literal["text", "number", "date", "bool", "choice"] | no | no | — | Present in CustomFieldSummary. |
| `items[].required` | boolean | no | no | — | Present in CustomFieldSummary. |
...
Route: `POST /companies/{company_id}/commands/custom-field.show`
...
Route: `POST /companies/{company_id}/commands/custom-field.update`
