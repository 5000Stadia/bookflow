...
Read a bounded page of an owned collection of item.
...
| Capability | item |
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/item.query.children` |
| External binary body | none |

### CLI

`bookflow item query children --record 01ARZ3NDEKTSV4RRFFQ69G5FAV --column members --limit 50 --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/item.query.children`
...
Discover a bounded page of named columns, filters, sorts or custom choices for items.
...
| Capability | item |
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/item.query.options` |
| External binary body | none |

### CLI

`bookflow item query options --kind columns --limit 50 --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/item.query.options`
