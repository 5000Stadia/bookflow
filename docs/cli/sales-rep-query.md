...
# `sales-rep query` commands

## `sales-rep query options`

Discover a bounded page of named columns, filters, sorts or custom choices for sales representatives.
...
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/sales-rep.query.options` |
| External binary body | none |

### CLI

`bookflow sales-rep query options --kind columns --limit 50 --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/sales-rep.query.options`
