...
|---|---|---|---|---|---|---|
| `job_type` | `JOB_TYPE` | string | yes | no | — | job-type id or canonical name |
...
Route: `POST /companies/{company_id}/commands/job-type.activate`
...
Route: `POST /companies/{company_id}/commands/job-type.create`
...
Route: `POST /companies/{company_id}/commands/job-type.deactivate`
...
Route: `POST /companies/{company_id}/commands/job-type.list`
...
Route: `POST /companies/{company_id}/commands/job-type.query`
...
| `items[].active` | boolean | yes | no | — | — |
| `items[].full_name` | string | no | no | — | Present in JobTypeSummary. |
| `items[].parent_id` | string \| null | no | yes | — | Present in JobTypeSummary. |
...
Route: `POST /companies/{company_id}/commands/job-type.show`
...
Route: `POST /companies/{company_id}/commands/job-type.update`
