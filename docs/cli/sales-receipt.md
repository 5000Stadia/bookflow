...
| Capability | transaction.sales_receipt.delete |
| Additional resources | ledger.read: member |
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/sales-receipt.delete` |
...
| `sales_receipt` | `SALES_RECEIPT` | string | yes | no | — | minimum length 1 |
...
Route: `POST /companies/{company_id}/commands/sales-receipt.delete`
...
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/sales-receipt.history` |
| External binary body | none |
...
Route: `POST /companies/{company_id}/commands/sales-receipt.history`
...
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/sales-receipt.post` |
| External binary body | none |
...
Route: `POST /companies/{company_id}/commands/sales-receipt.post`
...
| Capability | ledger.read |
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/sales-receipt.query` |
| External binary body | none |
...
Route: `POST /companies/{company_id}/commands/sales-receipt.query`
...
| Capability | ledger.read |
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/sales-receipt.show` |
| External binary body | none |
...
Route: `POST /companies/{company_id}/commands/sales-receipt.show`
...
| Capability | ledger.post |
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/sales-receipt.update` |
| External binary body | none |
...
Route: `POST /companies/{company_id}/commands/sales-receipt.update`
...
| Capability | ledger.post |
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/sales-receipt.void` |
| External binary body | none |
...
Route: `POST /companies/{company_id}/commands/sales-receipt.void`
