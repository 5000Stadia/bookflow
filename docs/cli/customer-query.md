...
# `customer query` commands

## `customer query options`

Discover a bounded page of named columns, filters, sorts or custom choices for customers and jobs.
...
| Capability | customer |
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/customer.query.options` |
| External binary body | none |

### CLI

`bookflow customer query options --kind columns --limit 50 --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/customer.query.options`
