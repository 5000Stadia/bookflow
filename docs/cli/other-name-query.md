...
# `other-name query` commands

## `other-name query options`

Discover a bounded page of named columns, filters, sorts or custom choices for other names.
...
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/other-name.query.options` |
| External binary body | none |

### CLI

`bookflow other-name query options --kind columns --limit 50 --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/other-name.query.options`
