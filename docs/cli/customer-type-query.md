...
# `customer-type query` commands

## `customer-type query options`

Discover a bounded page of named columns, filters, sorts or custom choices for customer types.
...
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/customer-type.query.options` |
| External binary body | none |

### CLI

`bookflow customer-type query options --kind columns --limit 50 --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/customer-type.query.options`
