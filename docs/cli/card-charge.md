...
| Capability | transaction.card_charge.delete |
| Additional resources | ledger.read: member |
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/card-charge.delete` |
...
Route: `POST /companies/{company_id}/commands/card-charge.delete`
