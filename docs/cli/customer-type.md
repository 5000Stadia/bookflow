...
`bookflow customer-type activate 01ARZ3NDEKTSV4RRFFQ69G5FAV --expected-version 2 --company "Demo Plumbing Co" --json`

### Input

| JSON field | CLI input | Type | Required | Nullable | Default | Description and constraints |
|---|---|---|---|---|---|---|
| `customer_type` | `CUSTOMER_TYPE` | string | yes | no | — | customer-type id or canonical name |
...
Route: `POST /companies/{company_id}/commands/customer-type.activate`
...
`bookflow customer-type create --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/customer-type.create`
...
`bookflow customer-type deactivate 01ARZ3NDEKTSV4RRFFQ69G5FAV --expected-version 1 --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/customer-type.deactivate`
...
`bookflow customer-type list --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/customer-type.list`
...
Query a bounded page of customer types.
...
`bookflow customer-type query --limit 25 --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/customer-type.query`
...
| `items[].active` | boolean | yes | no | — | — |
| `items[].full_name` | string | no | no | — | Present in CustomerTypeSummary. |
| `items[].parent_id` | string \| null | no | yes | — | Present in CustomerTypeSummary. |
...
`bookflow customer-type show 01ARZ3NDEKTSV4RRFFQ69G5FAV --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/customer-type.show`
...
`bookflow customer-type update 01ARZ3NDEKTSV4RRFFQ69G5FAV --expected-version 1 --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/customer-type.update`
