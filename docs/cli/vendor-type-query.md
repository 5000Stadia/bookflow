...
# `vendor-type query` commands

## `vendor-type query options`

Discover a bounded page of named columns, filters, sorts or custom choices for vendor types.
...
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/vendor-type.query.options` |
...
Route: `POST /companies/{company_id}/commands/vendor-type.query.options`
