...
| `revision.source.components` | array[object] | no | no | [] | — |
| `revision.source.components[].id` | string | yes | no | — | — |
| `revision.source.components[].created_at` | string | yes | no | — | — |
| `revision.source.components[].created_by` | string | yes | no | — | — |
| `revision.source.components[].created_via` | string | yes | no | — | — |
| `revision.source.components[].transaction_id` | string | yes | no | — | — |
| `revision.source.components[].revision_id` | string | yes | no | — | — |
| `revision.source.components[].key_id` | string | yes | no | — | — |
| `revision.source.components[].document_line_id` | string | yes | no | — | — |
| `revision.source.components[].ordinal` | integer | yes | no | — | — |
| `revision.source.components[].posting_source_id` | string | yes | no | — | — |
| `revision.source.components[].amount` | object | yes | no | — | — |
| `revision.source.components[].amount.amount` | string | yes | no | — | — |
| `revision.source.components[].amount.currency` | string | yes | no | — | — |
| `revision.source.components[].amount.minor_units` | integer | yes | no | — | — |
| `revision.source.components[].amount_minor_units` | integer | yes | no | — | — |
| `revision.source.components[].currency` | string | yes | no | — | — |
| `revision.source.components[].audit_event_id` | string | yes | no | — | — |
| `revision.source.components[].applied_minor_units` | integer | yes | no | — | — |
| `revision.source.components[].applied` | object | yes | no | — | — |
| `revision.source.components[].applied.amount` | string | yes | no | — | — |
| `revision.source.components[].applied.currency` | string | yes | no | — | — |
| `revision.source.components[].applied.minor_units` | integer | yes | no | — | — |
