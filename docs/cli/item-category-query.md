...
# `item-category query` commands

## `item-category query options`

Discover a bounded page of named columns, filters, sorts or custom choices for item categories.
...
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/item-category.query.options` |
| External binary body | none |

### CLI

`bookflow item-category query options --kind columns --limit 50 --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/item-category.query.options`
