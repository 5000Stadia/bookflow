...
# `vendor query` commands

## `vendor query children`

Read a bounded page of an owned collection of vendor.
...
| Capability | vendor |
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/vendor.query.children` |
| External binary body | none |

### CLI

`bookflow vendor query children --record 01ARZ3NDEKTSV4RRFFQ69G5FAV --column expense_accounts --limit 50 --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/vendor.query.children`
...
Discover a bounded page of named columns, filters, sorts or custom choices for vendors.
...
| Capability | vendor |
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/vendor.query.options` |
| External binary body | none |

### CLI

`bookflow vendor query options --kind columns --limit 50 --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/vendor.query.options`
