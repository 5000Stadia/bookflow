...
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/customer-message.activate` |
| External binary body | none |

### CLI

`bookflow customer-message activate 01ARZ3NDEKTSV4RRFFQ69G5FAV --expected-version 2 --company "Demo Plumbing Co" --json`

### Input

| JSON field | CLI input | Type | Required | Nullable | Default | Description and constraints |
|---|---|---|---|---|---|---|
| `customer_message` | `CUSTOMER_MESSAGE` | string | yes | no | — | customer-message id or canonical name |
...
Route: `POST /companies/{company_id}/commands/customer-message.activate`
...
| Capability | customer-message |
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/customer-message.create` |
| External binary body | none |

### CLI

`bookflow customer-message create --company "Demo Plumbing Co" --json`
...
| `text` | `--text` | string | yes | no | — | minimum length 1; maximum length 101 |
| `display_order` | `--display-order` | integer | no | no | 0 | minimum 0 |
...
Route: `POST /companies/{company_id}/commands/customer-message.create`
...
| Capability | customer-message |
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/customer-message.deactivate` |
| External binary body | none |

### CLI

`bookflow customer-message deactivate 01ARZ3NDEKTSV4RRFFQ69G5FAV --expected-version 1 --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/customer-message.deactivate`
...
| Capability | customer-message |
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/customer-message.list` |
| External binary body | none |

### CLI

`bookflow customer-message list --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/customer-message.list`
...
| `items[].display_order` | integer | yes | no | — | — |
...
Query a bounded page of customer messages.
...
| Capability | customer-message |
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/customer-message.query` |
| External binary body | none |

### CLI

`bookflow customer-message query --limit 25 --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/customer-message.query`
...
| `items[].active` | boolean | yes | no | — | — |
| `items[].name` | string | no | no | — | Present in CustomerMessageSummary. |
| `items[].display_order` | integer | no | no | — | Present in CustomerMessageSummary. |
| `items[].text` | string | no | no | — | Present in CustomerMessageSummary. |
...
| Capability | customer-message |
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/customer-message.show` |
| External binary body | none |

### CLI

`bookflow customer-message show 01ARZ3NDEKTSV4RRFFQ69G5FAV --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/customer-message.show`
...
| Capability | customer-message |
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/customer-message.update` |
| External binary body | none |

### CLI

`bookflow customer-message update 01ARZ3NDEKTSV4RRFFQ69G5FAV --expected-version 1 --company "Demo Plumbing Co" --json`
...
| `text` | `--text` | string \| null | no | yes | null | — |
| `display_order` | `--display-order` | integer \| null | no | yes | null | — |
...
Route: `POST /companies/{company_id}/commands/customer-message.update`
