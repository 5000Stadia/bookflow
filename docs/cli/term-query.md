...
Discover a bounded page of named columns, filters, sorts or custom choices for terms.
...
| Capability | term |
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/term.query.options` |
| External binary body | none |

### CLI

`bookflow term query options --kind columns --limit 50 --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/term.query.options`
