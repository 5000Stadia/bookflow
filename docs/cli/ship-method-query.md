...
# `ship-method query` commands

## `ship-method query options`

Discover a bounded page of named columns, filters, sorts or custom choices for ship methods.
...
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/ship-method.query.options` |
| External binary body | none |

### CLI

`bookflow ship-method query options --kind columns --limit 50 --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/ship-method.query.options`
