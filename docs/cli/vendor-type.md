...
| Capability | vendor-type |
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/vendor-type.activate` |
| External binary body | none |

### CLI

`bookflow vendor-type activate 01ARZ3NDEKTSV4RRFFQ69G5FAV --expected-version 2 --company "Demo Plumbing Co" --json`

### Input

| JSON field | CLI input | Type | Required | Nullable | Default | Description and constraints |
|---|---|---|---|---|---|---|
| `vendor_type` | `VENDOR_TYPE` | string | yes | no | — | vendor-type id or canonical name |
...
Route: `POST /companies/{company_id}/commands/vendor-type.activate`
...
| Capability | vendor-type |
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/vendor-type.create` |
| External binary body | none |

### CLI

`bookflow vendor-type create --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/vendor-type.create`
...
| Capability | vendor-type |
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/vendor-type.deactivate` |
| External binary body | none |

### CLI

`bookflow vendor-type deactivate 01ARZ3NDEKTSV4RRFFQ69G5FAV --expected-version 1 --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/vendor-type.deactivate`
...
| Capability | vendor-type |
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/vendor-type.list` |
| External binary body | none |

### CLI

`bookflow vendor-type list --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/vendor-type.list`
...
Query a bounded page of vendor types.
...
| Capability | vendor-type |
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/vendor-type.query` |
| External binary body | none |

### CLI

`bookflow vendor-type query --limit 25 --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/vendor-type.query`
...
| `items[].active` | boolean | yes | no | — | — |
| `items[].full_name` | string | no | no | — | Present in VendorTypeSummary. |
| `items[].parent_id` | string \| null | no | yes | — | Present in VendorTypeSummary. |
...
| Capability | vendor-type |
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/vendor-type.show` |
| External binary body | none |

### CLI

`bookflow vendor-type show 01ARZ3NDEKTSV4RRFFQ69G5FAV --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/vendor-type.show`
...
| Capability | vendor-type |
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/vendor-type.update` |
| External binary body | none |

### CLI

`bookflow vendor-type update 01ARZ3NDEKTSV4RRFFQ69G5FAV --expected-version 1 --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/vendor-type.update`
