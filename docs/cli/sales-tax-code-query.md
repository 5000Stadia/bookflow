...
# `sales-tax-code query` commands

## `sales-tax-code query options`

Discover a bounded page of named columns, filters, sorts or custom choices for sales tax codes.
...
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/sales-tax-code.query.options` |
| External binary body | none |

### CLI

`bookflow sales-tax-code query options --kind columns --limit 50 --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/sales-tax-code.query.options`
