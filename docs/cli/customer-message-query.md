...
# `customer-message query` commands

## `customer-message query options`

Discover a bounded page of named columns, filters, sorts or custom choices for customer messages.
...
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/customer-message.query.options` |
| External binary body | none |

### CLI

`bookflow customer-message query options --kind columns --limit 50 --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/customer-message.query.options`
