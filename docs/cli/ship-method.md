...
`bookflow ship-method activate 01ARZ3NDEKTSV4RRFFQ69G5FAV --expected-version 2 --company "Demo Plumbing Co" --json`

### Input

| JSON field | CLI input | Type | Required | Nullable | Default | Description and constraints |
|---|---|---|---|---|---|---|
| `ship_method` | `SHIP_METHOD` | string | yes | no | — | ship-method id or canonical name |
...
Route: `POST /companies/{company_id}/commands/ship-method.activate`
...
`bookflow ship-method create --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/ship-method.create`
...
`bookflow ship-method deactivate 01ARZ3NDEKTSV4RRFFQ69G5FAV --expected-version 1 --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/ship-method.deactivate`
...
`bookflow ship-method list --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/ship-method.list`
...
Query a bounded page of ship methods.
...
`bookflow ship-method query --limit 25 --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/ship-method.query`
...
| `items[].active` | boolean | yes | no | — | — |
| `items[].name` | string | no | no | — | Present in ShipMethodSummary. |
| `items[].display_order` | integer | no | no | — | Present in ShipMethodSummary. |
...
`bookflow ship-method show 01ARZ3NDEKTSV4RRFFQ69G5FAV --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/ship-method.show`
...
`bookflow ship-method update 01ARZ3NDEKTSV4RRFFQ69G5FAV --expected-version 1 --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/ship-method.update`
