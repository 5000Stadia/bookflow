...
`bookflow sales-tax-code activate 01ARZ3NDEKTSV4RRFFQ69G5FAV --expected-version 2 --company "Demo Plumbing Co" --json`

### Input

| JSON field | CLI input | Type | Required | Nullable | Default | Description and constraints |
|---|---|---|---|---|---|---|
| `sales_tax_code` | `SALES_TAX_CODE` | string | yes | no | — | sales-tax-code id or canonical name |
...
Route: `POST /companies/{company_id}/commands/sales-tax-code.activate`
...
| `code` | string | yes | no | — | — |
| `description` | string \| null | no | yes | null | — |
...
`bookflow sales-tax-code create --company "Demo Plumbing Co" --json`

### Input

| JSON field | CLI input | Type | Required | Nullable | Default | Description and constraints |
|---|---|---|---|---|---|---|
| `code` | `--code` | string | yes | no | — | minimum length 1; maximum length 3 |
...
Route: `POST /companies/{company_id}/commands/sales-tax-code.create`
...
`bookflow sales-tax-code deactivate 01ARZ3NDEKTSV4RRFFQ69G5FAV --expected-version 1 --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/sales-tax-code.deactivate`
...
`bookflow sales-tax-code list --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/sales-tax-code.list`
...
| `items[].description` | string \| null | no | yes | null | — |
| `items[].taxable` | boolean | yes | no | — | — |
...
`bookflow sales-tax-code show 01ARZ3NDEKTSV4RRFFQ69G5FAV --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/sales-tax-code.show`
...
`bookflow sales-tax-code update 01ARZ3NDEKTSV4RRFFQ69G5FAV --expected-version 1 --company "Demo Plumbing Co" --json`
...
| `sales_tax_code` | `SALES_TAX_CODE` | string | yes | no | — | sales-tax-code id or canonical name |
| `expected_version` | `--expected-version` | integer \| null | no | yes | null | — |
| `code` | `--code` | string \| null | no | yes | null | — |
| `description` | `--description` | string \| null | no | yes | null | — |
| `taxable` | `--taxable` | boolean \| null | no | yes | null | — |
...
Route: `POST /companies/{company_id}/commands/sales-tax-code.update`
