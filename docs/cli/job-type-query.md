...
# `job-type query` commands

## `job-type query options`

Discover a bounded page of named columns, filters, sorts or custom choices for job types.
...
| Capability | job-type |
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/job-type.query.options` |
| External binary body | none |

### CLI

`bookflow job-type query options --kind columns --limit 50 --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/job-type.query.options`
