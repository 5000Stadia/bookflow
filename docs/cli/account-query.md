...
Discover a bounded page of named columns, filters, sorts or custom choices for accounts.
...
| Capability | account |
| Feature | — |
| HTTP | `POST /companies/{company_id}/commands/account.query.options` |
| External binary body | none |

### CLI

`bookflow account query options --kind columns --limit 50 --company "Demo Plumbing Co" --json`
...
Route: `POST /companies/{company_id}/commands/account.query.options`
