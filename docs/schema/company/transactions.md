...
| `type` | VARCHAR(32) | no | — | unique with id + type, unique with type + number | ix_co17_transactions_current, ix_co17_transactions_type | — | Business document type: journal_entry, invoice, statement_charge, sales_receipt, payment, deposit, bill, bill_payment, credit_memo, sales_tax_payment, customer_refund or vendor_credit. |
