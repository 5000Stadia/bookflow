...
NOUN_META_OVERRIDES: dict[str, dict[str, str | None]] = {
    ...
    "credit-memo": {"record_type": "transaction", "identifier": "credit_memo", "output_identifier": "id", "display_field": "number", "singular_label": "Credit memo", "plural_label": "Credit memos"},
    "customer-credit": {"record_type": None, "identifier": None},
    "customer-refund": {"record_type": "transaction", "identifier": "refund", "output_identifier": "id", "display_field": "number", "singular_label": "Customer refund", "plural_label": "Customer refunds"},
