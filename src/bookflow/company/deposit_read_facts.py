...
def load_complete(s,deposit_ids,*,binding,annotations=('note','attachment')):
    # Narrow acquisition separation for the public reader: an annotation kind
    # its audience is not admitted to is never queried, not merely filtered.
    # Private callers keep the complete default.
