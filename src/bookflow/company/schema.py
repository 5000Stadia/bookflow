...
from bookflow.company.reconciliation_materialization_schema import define_tables as _define_materialization_tables

globals().update(_define_materialization_tables(metadata, _column, _table))
...
from bookflow.company.credit_schema import define_tables as _define_credit_tables
globals().update(_define_credit_tables(metadata, _column, _table))

from bookflow.company.sales_tax_settlement_schema import define_tables as _define_sales_tax_settlement_tables
globals().update(_define_sales_tax_settlement_tables(metadata, _column, _table))
