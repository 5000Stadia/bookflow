...
def define_tables(metadata, column, table):
    ...
    work_billing_allocations = T('work_billing_allocations',
        ...
        C('allocation_version', sa.Integer, '1 occupies the full root; 2 carries legacy-basis intervals; 3 carries basis2 intervals.', nullable=False, server_default='1'),
