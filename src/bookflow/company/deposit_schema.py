...
def define_tables(metadata, column, table, common):
    ...
    component_keys = T('deposit_component_keys', ident('id', 'Permanent semantic occurrence.', primary_key=True),
        ...
        integer('ordinal', 'Permanent component tie ordinal.'), text('kind', 'payment, sale_net, sale_tax, additional or header.'),
        text('semantic_identity', 'Permanent payment key, sale line, additional row or header identity.'),
        text('tax_item_id', 'Tax item for sale_tax; empty otherwise.'), *created(), positive('ordinal'),
    ...
    components = T('deposit_components', ident('id', 'Revision-local funding component.', primary_key=True),
        ...
        ident('row_id', 'Durable deposit row occurrence.'), integer('component_ordinal', 'Durable source component occurrence.'),
        ...
        *created(), positive('capacity'), positive('component_ordinal'), obj('facts_snapshot'),
