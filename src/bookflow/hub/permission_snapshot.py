...
def _load_root(tx: Database, *, catalog: CatalogBundle) -> RootFacts:
    ...
    # The supported hub schema is whatever the chain's head is; pinning the literal here
    # is how a revision bump silently turns every policy read into a schema mismatch.
