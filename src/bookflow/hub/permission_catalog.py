...
FROZEN_COMPANY_ACTIONS = (
    ...
    CompanyAction(key='card-charge post', requirements=(Requirement(capability='ledger.post', threshold='standard'),), available=True, remaining_graph_owners=('bookflow.commands.check_cmds._post.<locals>.planner|src/bookflow/commands/check_cmds.py',)),
    ...
    CompanyAction(key='check post', requirements=(Requirement(capability='ledger.post', threshold='standard'),), available=True, remaining_graph_owners=('bookflow.commands.check_cmds._post.<locals>.planner|src/bookflow/commands/check_cmds.py',)),
    ...
    CompanyAction(key='transfer post', requirements=(Requirement(capability='ledger.post', threshold='standard'),), available=True, remaining_graph_owners=('bookflow.commands.transfer_cmds._planner|src/bookflow/commands/transfer_cmds.py',)),
