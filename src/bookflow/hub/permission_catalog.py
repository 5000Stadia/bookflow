...
FROZEN_COMMANDS = (
    ...
    CommandDescriptor(name='payment selection clear', routed_scope='company', capability='ledger.post', threshold='standard', resources=(), available=True, feature=None, local_only=False, bootstrap=False, authorization_text=None, conditional_owner=None, permanent_recovery_owner=None, transfer_owner=None),
    CommandDescriptor(name='payment selection create', routed_scope='company', capability='ledger.post', threshold='standard', resources=(), available=True, feature=None, local_only=False, bootstrap=False, authorization_text=None, conditional_owner=None, permanent_recovery_owner=None, transfer_owner=None),
    ...
    CommandDescriptor(name='payment selection update', routed_scope='company', capability='ledger.post', threshold='standard', resources=(), available=True, feature=None, local_only=False, bootstrap=False, authorization_text=None, conditional_owner=None, permanent_recovery_owner=None, transfer_owner=None),
...
FROZEN_COMPANY_ACTIONS = (
    ...
    CompanyAction(key='payment selection clear', requirements=(Requirement(capability='ledger.post', threshold='standard'),), available=True, remaining_graph_owners=('bookflow.commands.payment_cmds._write.<locals>.plan|src/bookflow/commands/payment_cmds.py',)),
    CompanyAction(key='payment selection create', requirements=(Requirement(capability='ledger.post', threshold='standard'),), available=True, remaining_graph_owners=('bookflow.commands.payment_cmds._write.<locals>.plan|src/bookflow/commands/payment_cmds.py',)),
    ...
    CompanyAction(key='payment selection update', requirements=(Requirement(capability='ledger.post', threshold='standard'),), available=True, remaining_graph_owners=('bookflow.commands.payment_cmds._write.<locals>.plan|src/bookflow/commands/payment_cmds.py',)),
...
CONDITIONAL_RESOURCE_SOURCES = (
    ...
    ResourceSource(owner='bookflow.company.payment_authority.authorize_event', call_sites=(('src/bookflow/company/payment_authority.py', 354),), requirements=(Requirement(capability='customer-work', threshold='member'), Requirement(capability='ledger.read', threshold='member'))),
    ResourceSource(owner='bookflow.company.payment_authority.authorize_events', call_sites=(('src/bookflow/company/payment_authority.py', 369),), requirements=(Requirement(capability='customer-work', threshold='member'), Requirement(capability='ledger.read', threshold='member'))),
    ...
    ResourceSource(owner='bookflow.company.payment_authority.denied_events', call_sites=(('src/bookflow/company/payment_authority.py', 387),), requirements=(Requirement(capability='customer-work', threshold='member'), Requirement(capability='ledger.read', threshold='member'))),
