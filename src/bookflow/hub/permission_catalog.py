...
CONDITIONAL_RESOURCE_SOURCES = (
    ...
    ResourceSource(owner='bookflow.company.payment_authority.authorize_event', call_sites=(('src/bookflow/company/payment_authority.py', 377),), requirements=(Requirement(capability='customer-work', threshold='member'), Requirement(capability='ledger.read', threshold='member'))),
    ResourceSource(owner='bookflow.company.payment_authority.authorize_events', call_sites=(('src/bookflow/company/payment_authority.py', 392),), requirements=(Requirement(capability='customer-work', threshold='member'), Requirement(capability='ledger.read', threshold='member'))),
    ResourceSource(owner='bookflow.company.payment_authority.authorize_publication_selections', call_sites=(('src/bookflow/company/payment_authority.py', 637),), requirements=(Requirement(capability='customer-work', threshold='member'), Requirement(capability='customer-work', threshold='standard'), Requirement(capability='ledger.post', threshold='standard'), Requirement(capability='ledger.read', threshold='member'))),
    ResourceSource(owner='bookflow.company.payment_authority.authorize_publication_transactions', call_sites=(('src/bookflow/company/payment_authority.py', 487), ('src/bookflow/company/payment_authority.py', 489)), requirements=(Requirement(capability='customer-work', threshold='member'), Requirement(capability='customer-work', threshold='standard'), Requirement(capability='ledger.post', threshold='standard'), Requirement(capability='ledger.read', threshold='member'))),
    ...
    ResourceSource(owner='bookflow.company.payment_authority.denied_events', call_sites=(('src/bookflow/company/payment_authority.py', 410),), requirements=(Requirement(capability='customer-work', threshold='member'), Requirement(capability='ledger.read', threshold='member'))),
