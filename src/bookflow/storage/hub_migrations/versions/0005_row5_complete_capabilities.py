"""Complete Row 5 capability projection.
...
revision = "hub0005"
down_revision = "hub0004"


# Frozen command requirements for the completed Row 5 registry. Keep this
# revision local: databases already at hub0004 must receive the expanded seed,
# and historical migrations must never import the live registry.
