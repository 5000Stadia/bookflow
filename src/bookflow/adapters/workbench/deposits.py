...
nothing else. Deposit writes are not registered, so there is no Modify or Void
action here. The detail page is the bounded summary alone: the composition is
