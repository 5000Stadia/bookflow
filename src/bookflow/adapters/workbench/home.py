    ...
    Panel(
        ...
        steps=(
            ...
            Step(
                id="reports",
                title="Reports",
                summary="Trial balance, profit and loss, balance sheet, general ledger.",
                action=Action(
                    "Choose a report to run",
                    READ,
                    ("report trial-balance", "report profit-and-loss", "report balance-sheet", "report general-ledger"),
                    "/_group/reports",
                ),
            ),
            Step(
