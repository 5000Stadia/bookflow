...
def mount_workbench(app: FastAPI, host, credential, make_context, run_command, secure_cookies: bool) -> None:
    ...
    static_urls = {
        ...
        for name in ("style.css", "htmx.min.js", "numeric-context.js", "numeric-entry.js", "workflow.js", "annotations.js", "register.js", "register.css", "sales.js", "sales.css", "browsing.js", "browsing.css")
    }
